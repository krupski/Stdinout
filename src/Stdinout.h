...
static Stream *stream_ptr0; // stdin stream pointer
static Stream *stream_ptr1; // stdout stream pointer
static Stream *stream_ptr2; // stderr stream pointer
static Stream *stream_null; // null stream pointer
